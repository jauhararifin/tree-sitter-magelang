...
enum {
  ...
  anon_sym_BSLASH = 6,
  aux_sym_string_literal_token2 = 7,
  aux_sym_string_literal_token3 = 8,
  aux_sym_string_literal_token4 = 9,
  aux_sym_string_literal_token5 = 10,
  aux_sym_string_literal_token6 = 11,
  sym_comment = 12,
  sym_source_file = 13,
  sym_item = 14,
  sym_import = 15,
  ...
  aux_sym_string_literal_repeat1 = 19,
};
  ...
  switch (state) {
    ...
    case 2:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == '\r' ||
          lookahead == ' ') SKIP(2)
      if (aux_sym_identifier_token1_character_set_1(lookahead)) ADVANCE(28);
      END_STATE();
    case 3:
    ...
    case 28:
      ...
      if (aux_sym_identifier_token1_character_set_2(lookahead)) ADVANCE(28);
      END_STATE();
    case 29:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [18] = {.entry = {.count = 1, .reusable = false}}, SHIFT_EXTRA(),
  [20] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  ...
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(7),
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(4),
  [38] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item, 1),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 4),
